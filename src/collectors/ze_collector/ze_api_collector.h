#ifndef FTRACE_TOOLS_COLLECTORS_ZE_COLLECTOR_ZE_API_COLLECTOR_H_
#define FTRACE_TOOLS_COLLECTORS_ZE_COLLECTOR_ZE_API_COLLECTOR_H_
...
#endif // FTRACE_TOOLS_COLLECTORS_ZE_COLLECTOR_ZE_API_COLLECTOR_H_