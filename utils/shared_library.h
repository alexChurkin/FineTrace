#ifndef FTRACE_UTILS_SHARED_LIBRARY_H_
#define FTRACE_UTILS_SHARED_LIBRARY_H_
...
class SharedLibrary {
 public:
  ...
  ~SharedLibrary() {
    ...
    FTRACE_ASSERT(completed == TRUE);
#else
    int completed = dlclose(handle_);
    FTRACE_ASSERT(completed == 0);
#endif
  }
...
#endif // FTRACE_UTILS_SHARED_LIBRARY_H_