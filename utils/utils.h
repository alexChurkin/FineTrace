#ifndef FTRACE_UTILS_UTILS_H_
#define FTRACE_UTILS_UTILS_H_
...
#ifdef _WIN32
#define FTRACE_EXPORT __declspec(dllexport)
#else
#define FTRACE_EXPORT __attribute__ ((visibility ("default")))
#endif
...
inline void SetEnv(const char* name, const char* value) {
  FTRACE_ASSERT(name != nullptr);
  FTRACE_ASSERT(value != nullptr);
