#ifndef FTRACE_GTPIN_TOOL_H
#define FTRACE_GTPIN_TOOL_H
...
class GTPinTool : public gtpin::IGtTool {
 public:
  ...
  uint32_t ApiVersion() const final {
    ...
    // tool
#ifdef FTRACE_GTPIN_GTPIN_API_VERSION
    return FTRACE_GTPIN_GTPIN_API_VERSION;
#else
