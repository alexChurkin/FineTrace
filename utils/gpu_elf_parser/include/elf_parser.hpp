...
#ifndef FTRACE_ELF_PARSER_HPP_
#define FTRACE_ELF_PARSER_HPP_
...
class ElfParser {
 public:
   ...
   *
   */
  ftrace_result GetKernelNames(uint32_t num_entries, const char** names, uint32_t* num_names) const;
